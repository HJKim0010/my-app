...
function buildPlannerInput(params: PlannerParams, localPlan: ConversationPlannerOutput): string {
  return [
    ...
    "- Source summaries, source recaps, detailed source comprehension, and event-sequence reconstruction are allowed; they are not ghostwriting.",
    "- Use canonical source context for broad source/story questions, whole-source summaries, source recaps, factual or interpretive source questions, and source compatibility.",
