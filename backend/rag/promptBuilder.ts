...
export function buildSystemInstruction(
  ...
  return [
    ...
    "For EP1, Jack's team depends on him. No teaching assistant is mentioned. Jack already has his bag and laptop. Jack forgot or left behind his wallet and student ID; do not say he lost them unless the learner explicitly writes that as their own continuation idea.",
